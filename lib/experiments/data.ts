...
export const EXPERIMENT_002: Experiment = {
  ...
  title: 'EMA Momentum Reversal Backtest',
  subtitle:
    'A controlled historical backtest of the DHA-DEMO-EMA-MOM strategy on RELIANCE.NS, testing execution behavior, costs and strategy performance across 72 daily bars.',
  status: 'Completed',
  type: 'Historical Backtest',
  backtestId: 'BT-AA2DA005',
  strategyId: 'DHA-DEMO-EMA-MOM v1',
  strategyName: 'EMA Momentum Reversal Alpha',
  ...
  netPnl: '-₹883.34',
  returnPct: '-0.88%',
  maximumDrawdown: '-0.91%',
  maximumDrawdownAmount: '₹912.23',
  profitFactor: '0.00',
  commission: '₹78.75',
  slippage: '₹39.37',
  totalExecutionCosts: '₹118.12',
  finalEquity: '₹99,116.66',
  timestamp: '2026-09-17 07:06:15 UTC',
  whatWeTested: [
    {
  ...
  summaryPoints: [
    ...
    '₹99,116.66 final equity',
    '-0.88% backtest result',
  ],
  disclosure:
    'This is a historical simulation produced by Dhanvi’s backtesting engine. It does not represent live trading performance or expected future returns. Backtests are subject to assumptions and limitations including data quality, execution modeling, commissions, slippage, liquidity and market behavior. Past or simulated performance does not guarantee future results.',
}
