...
export function ProblemSection() {
  return (
    <section id="research" className="py-24 sm:py-32 border-t border-[#E5E8E5] bg-[#F7F8F6]">
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 pt-8 border-t border-[#E5E8E5]">
          {/* Left Column (5 cols): The Traditional Model */}
          <div className="lg:col-span-5 space-y-6">
            <div className="text-xs font-mono text-[#929892]">
              TRADITIONAL ARCHITECTURE
            </div>
            <h3 className="text-xl font-medium text-[#101310]">
            ...
            <ul className="space-y-4 pt-2 text-xs text-[#606660]">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#929892] shrink-0 mt-1.5" />
                <span>
                  <strong className="text-[#101310] font-medium">Cognitive limits:</strong> Human analysts cannot parse thousands of global SEC filings, earnings calls, and tick streams in parallel.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#929892] shrink-0 mt-1.5" />
                <span>
                  <strong className="text-[#101310] font-medium">Context loss:</strong> When positions are closed, the original hypothesis, market regime context, and attribution details are rarely codified.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#929892] shrink-0 mt-1.5" />
                <span>
                  <strong className="text-[#101310] font-medium">Reactive risk:</strong> Human risk committees frequently adjust exposures after market volatility spikes have already occurred.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 lg:pl-8 lg:border-l lg:border-[#E5E8E5]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-lg border border-[#E5E8E5] bg-white">
                <div className="text-xs font-medium text-[#101310] mb-1">
                  Concurrent Perception
                </div>
                <div className="text-xs text-[#606660] leading-relaxed">
